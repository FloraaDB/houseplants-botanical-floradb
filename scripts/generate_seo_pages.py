...
def main():
    ...
    for p in plants:
        ...
        page_url = f"https://houseplants-botanical-floradb.pages.dev/plants/{slug}.html"
...
<head>
  ...
  {{
    ...
    "itemListElement": [
      ...
      {{"@type": "ListItem", "position": 2, "name": "Families Hub", "item": "https://houseplants-botanical-floradb.pages.dev/families/{fam_slug}.html"}},
...
<body>
  <header>
    <div class="container nav-bar">
      <a href="../index.html" class="brand">Flora<span class="accent">DB</span></a>
      <div>
        <a href="../index.html#explorer" class="btn-link">← Explorer</a>
        <a href="../families/{fam_slug}.html" class="btn-link">Family: {fam}</a>
      </div>
    </div>
  </header>
  ...
  <footer>
    <div class="container">
      <p>FloraDB — Botanical Houseplant Care & Pet-Toxicity Snapshot · <a href="../index.html#pricing" style="color:var(--accent); text-decoration:none;">Get Full Relational Dataset ($49)</a></p>
    </div>
  </footer>
</body>
</html>"""
    ...
    for fam_name, members in families.items():
        ...
        page_url = f"https://houseplants-botanical-floradb.pages.dev/families/{fam_slug}.html"
        ...
        <div class="card" style="display:flex; flex-direction:column; justify-content:space-between;">
          <div>
            ...
            <h3 class="serif" style="font-size:1.2rem; font-weight:700;"><a href="../plants/{m_slug}.html" style="color:var(--text-ink); text-decoration:none;">{sci}</a></h3>
          ...
          <div style="border-top:1px dashed var(--rule-color); padding-top:12px; font-size:0.85rem;">
            ...
            <div style="margin-top:14px; text-align:right;">
              <a href="../plants/{m_slug}.html" class="btn-link" style="margin:0; padding:6px 12px; font-size:0.8rem;">View Specimen Details →</a>
            </div>
          </div>
        </div>"""
...
<body>
  <header>
    <div class="container nav-bar">
      <a href="../index.html" class="brand">Flora<span class="accent">DB</span></a>
      <div>
        <a href="../index.html#explorer" class="btn-link">← Specimen Explorer</a>
        <a href="../index.html#pricing" class="btn-link">Full Dataset Snapshot ($49)</a>
      </div>
    </div>
  </header>
  ...
  <footer>
    <div class="container">
      <p>FloraDB — Houseplant Care & Pet-Toxicity Dataset · <a href="../index.html" style="color:var(--accent); text-decoration:none;">Back to Main Catalog</a></p>
    </div>
  </footer>
</body>
</html>"""
